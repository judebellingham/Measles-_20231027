...
color purple=#2C08FF, yellow = #E9FF00, blackInk=#000000, resetColour=#FFFFFF, blue = #1786FA;
...
void setup() {
  ...
  eyeDimater = smallerDimension*1/5;
  ...
  buttonFont = createFont("CalistoMT-BoldItalic-48", 55);
  //
  //DIVs
